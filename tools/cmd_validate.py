...
ENDPOINTS = {
    ...
    'nosql': ['http://localhost:8015/eval'],
...
def _get_endpoints(header):
    ...
    ROUTES = [
        ...
        (r'XSS', 'xss'),
        (r'XXE', 'xxe'),
        (r'Error-Based|Math-Based|Timing-Based|^OOB$|Cloud|IP Bypass|Protocol|URL Tricks|SSRF', 'ssrf'),
        ...
        (r'Java Serialized|ysoserial|Java Hessian', 'deser-java'),
        (r'\.NET', 'deser-dotnet'),
